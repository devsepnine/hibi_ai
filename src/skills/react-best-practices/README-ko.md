...
에이전트와 LLM에 맞춰 정리한 React·Next.js 성능 규칙.
...
- `CRITICAL` — 최우선. 성능 이득이 크다
- `HIGH` — 성능을 상당히 개선한다
- `MEDIUM-HIGH` — 중간에서 높은 수준의 이득
- `MEDIUM` — 중간 수준의 성능 개선
- `LOW-MEDIUM` — 낮음에서 중간 수준의 이득
- `LOW` — 점진적 개선
...
[Vercel](https://vercel.com)의 [@shuding](https://x.com/shuding)이 최초 작성. MIT 라이선스.
