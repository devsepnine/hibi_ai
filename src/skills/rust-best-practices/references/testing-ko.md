...
unit test, integration test, property-based testing, benchmarking을 포함한 Rust 테스팅 종합 가이드.
...
Rust의 testing 철학은 다음을 강조한다:
- **Safety**: 가능한 곳에서는 컴파일 타임에 버그 잡기
- **Confidence**: 종합적인 test coverage
- **Speed**: 빠른 test 실행
- **Clarity**: 명확한 test 이름과 assertion
