...
If no description and no `--file`, ask the user which journey to test. Then dispatch `Agent(subagent_type="e2e-runner", prompt=<journey + flags + repo context>)` and relay its report.
