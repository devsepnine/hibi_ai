...
**핵심 원칙**: "프롬프트 주변을 길게 쓰기보다 effort를 올려라." Opus 4.7은 더 낮은 effort에서 요청된 것만 한다 — 그 이상은 안 한다.

**낮은 effort에서의 도구 사용**: 도구 호출을 결합하고 적게 사용. 직접 행동 → 간결한 확인.
**높은 effort에서의 도구 사용**: 행동 전 계획 설명, 더 많은 도구 호출, 상세 요약.

**모델 선택**: 빈번한 경량 워커는 Haiku 4.5, 메인 개발·도구 중심 작업은 Sonnet 4.6, 깊은 추론·장시간(30분+) 에이전트 작업은 Opus 4.7.
